<!--<template>-->
<!--  <div>-->
<!--      &lt;!&ndash; this is the markup. you can change the details (your own name, your own avatar etc.) but don’t change the basic structure! &ndash;&gt;-->

<!--      <aside class="profile-card" >-->

<!--          <header>-->

<!--              &lt;!&ndash; here’s the avatar &ndash;&gt;-->
<!--              <a href="http://victory-design.ru/">-->
<!--                  <img :src="items.image" />-->
<!--              </a>-->

<!--              &lt;!&ndash; the username &ndash;&gt;-->
<!--              <h1>{{items.firstname + ' ' + items.lastname}}</h1>-->

<!--              &lt;!&ndash; and role or location &ndash;&gt;-->
<!--              <h2>{{items.role}}</h2>-->
<!--              <b-field>-->
<!--                  <b-input v-model="items.faculty_id" icon=""></b-input>-->
<!--                  <p class="control">-->
...
<!--          &lt;!&ndash; bit of a bio; who are you? &ndash;&gt;-->
